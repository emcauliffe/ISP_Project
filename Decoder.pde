class Decoder {
  ...
  void update() {
    ...
    eshift=shift1-shift2;//Calculates the shift required in the numbers to encode the text and prints the math for it^^
    el=decode[1].length();//calculates the length of the message to be encoded
